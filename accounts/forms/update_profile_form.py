...
class ProfileUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = (
            'current_location', 'birthdate', 'languages', 'about', 'experience_resume', 'certificates', 'bank_details'
        )
        required = ('current_location', 'birthdate', 'languages', 'about', 'experience_resume', 'certificates', 'bank_details')
